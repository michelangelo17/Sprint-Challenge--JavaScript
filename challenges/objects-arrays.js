...
const tyrannosaurus = {
  //instructions say object name, but included name property in comment in case I misunderstood. Pattern continues with all three objects. 
  //name: 'tyrannosaurus', 
  diet: 'carnivorous', 
  weight: '7000kg', 
  length: '12m', 
...
const populationTotal = zooAnimals.reduce((totalAnimals, animal) => totalAnimals + animal.population, 0);
